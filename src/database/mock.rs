...
impl MockUserDatabase {
    pub fn new() -> Self {
        ...
        users.insert("johndoe".to_string(), User {
        ...
        tracing::info!("🗄️ Mock database initialized with {} sample users", users.len());
...
impl UserDatabase for MockUserDatabase {
    ...
    async fn health_check(&self) -> Result<String> {
        ...
        Ok(format!("mock_db_healthy_with_{}_users", user_count))
    }
}
